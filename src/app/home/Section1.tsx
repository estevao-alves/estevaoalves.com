...
export default function Section1() {
  ...
  const projects = [
    { Icon: <InstallySvg />, Title: 'Instally', Description: 'App that allows you to install multiple apps with <strong>One Click<strong/>', Url: 'https://instally.app/' },
    { Icon: <StoreSvg />, Title: '3D Shop', Description: 'Discover over 100+ unique 3D designs on T-shirts, mugs, stickers and <strong>more<strong/>', Url: 'https://www.cozydragon.shop/' }
  ];
